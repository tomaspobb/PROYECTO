...
const Reservas = () => {
    return (
        <div>
            <Head>
                <meta name="description" content="Realiza tu reserva en Sapori di Italia" />
            ...
            <main className="container py-5">
                ...
                <p>Para realizar una reserva, por favor contáctenos al número o correo electrónico indicado.</p>
                <p><strong>Teléfono:</strong> +56 9 1234 5678</p>
                <p><strong>Email:</strong> reservas@saporidiitalia.cl</p>
            </main>
